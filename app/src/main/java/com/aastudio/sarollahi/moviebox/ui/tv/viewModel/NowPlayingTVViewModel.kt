...
import com.aastudio.sarollahi.common.tracker.AIRING_TODAY_TV_ERROR
import retrofit2.Call

class NowPlayingTVViewModel(application: Application) : ViewModel() {
    ...
    private fun onTVShowsError(call: Call<GetTVShowResponse>, error: String) {
        ...
        logEvent(context, AIRING_TODAY_TV_ERROR, bundle)
    }
}
