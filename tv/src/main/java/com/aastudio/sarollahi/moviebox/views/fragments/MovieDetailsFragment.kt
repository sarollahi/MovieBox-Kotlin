...
import com.aastudio.sarollahi.moviebox.views.presenters.MovieDetailsDescriptionPresenter
...
class MovieDetailsFragment : DetailsSupportFragment() {
    ...
    private val detailFullOverviewPresenter =
        FullWidthDetailsOverviewRowPresenter(
            MovieDetailsDescriptionPresenter(),
...
//    }
    ...
    private fun loadBackground(selectedMovie: Movie) {
        Glide.with(requireActivity())
            .asBitmap()
